...
CREATE TABLE `c_requirements` (
  ...
  `range_low` int(30) DEFAULT NULL,
  `range_high` int(30) DEFAULT NULL,
  PRIMARY KEY (`CR_ID`),
  KEY `C_ID_idx` (`C_ID`)
...
INSERT INTO `c_requirements` VALUES (1,5,3,'San Jose','CA','95114','house',0,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2012-10-19 14:51:07
